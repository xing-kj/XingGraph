...
from xinggraph.modules.recall.types.RecallResponse import ResponseGraphEntry
...
from xinggraph.modules.tools.resolve_skills import find_skill_by_name
...
async def main() -> None:
    ...
    remembered = await xinggraph.remember(
        str(SKILLS_ROOT),
    ...
    proposal_result = await xinggraph.remember(
        SkillRunEntry(
