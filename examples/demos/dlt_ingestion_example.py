...
from xinggraph.modules.visualization.xinggraph_network_visualization import xinggraph_network_visualization
...
async def main():
    """Demonstrates all DLT-based data ingestion modes in XingGraph."""
    ...
    result = await xinggraph.recall("Which pet does Alice have?")
    ...
    result = await xinggraph.recall("Who works in Engineering?")
    ...
    result = await xinggraph.recall("What events happened?")
    ...
    result = await xinggraph.recall("What products are in inventory?")
    ...
    result = await xinggraph.recall("Who is Diana?")
    ...
    result = await xinggraph.recall("Who works in Engineering and is female?")
    ...
    await xinggraph_network_visualization(graph_data, dest)
