#!/usr/bin/env python3
"""
Example showing how to use xinggraph.start_ui() to launch the frontend.
...
async def main():
    # First, let's add some data to xinggraph for the UI to display
    print("Adding sample data to xinggraph...")
