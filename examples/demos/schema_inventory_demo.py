...
visualization code:
  ...
  * xinggraph_network_visualization  -> HTML with the PR3 schema side panel
...
DEST = os.path.join(os.path.expanduser("~"), "xinggraph_schema_demo.html")
