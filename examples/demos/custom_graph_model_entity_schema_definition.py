...
from xinggraph import SearchType, config, forget, recall, remember, visualize_graph
...
def set_up_config():
    ...
    xinggraph_directory_path = os.path.join(os.path.dirname(__file__), ".xinggraph_system")
