...
``xinggraph.api.v1.visualize.memory_provenance.build_provenance_graph`` — the same
...
import xinggraph
from xinggraph.api.v1.visualize.memory_provenance import build_provenance_graph
...
DEST = os.path.join(os.path.expanduser("~"), "xinggraph_provenance_demo.html")
...
async def main():
    ...
    live_nodes, live_edges = await xinggraph.get_memory_provenance_graph()
