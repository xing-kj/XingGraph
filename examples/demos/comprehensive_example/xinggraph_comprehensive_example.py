...
async def main():
    ...
    await xinggraph.remember(developer_intro, node_set=["developer_data"], self_improvement=False)
    ...
    await xinggraph.visualize_graph(initial_graph_visualization_path)
    ...
    await xinggraph.visualize_graph(enhanced_graph_visualization_path)
