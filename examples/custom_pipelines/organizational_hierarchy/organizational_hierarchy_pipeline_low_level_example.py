"""XingGraph demo with simplified structure."""
...
from xinggraph import config, prune, search, SearchType, visualize_graph
from xinggraph.low_level import setup, DataPoint
from xinggraph.pipelines import run_tasks, Task
...
DATA_DIR = ROOT / "data"
XINGGRAPH_DIR = ROOT / ".xinggraph_system"
...
async def execute_pipeline() -> None:
    """Execute XingGraph pipeline."""

    # Configure system paths
    logging.info("Configuring XingGraph directories at %s", XINGGRAPH_DIR)
    config.system_root_directory(str(XINGGRAPH_DIR))
