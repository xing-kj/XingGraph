...
# Notes: Nodesets xinggraph feature only works with Ladybug and Neo4j graph databases
...
from xinggraph.infrastructure.llm.LLMGateway import LLMGateway  # noqa: E402
from xinggraph.shared.logging_utils import setup_logging  # noqa: E402


class ProcurementMemorySystem:
    """Procurement system with persistent memory using XingGraph"""
    ...
    async def search_memory(self, query, search_categories=None):
        ...
        for category in search_categories:
            category_results = await xinggraph.recall(
...
async def run_procurement_example():
    ...
    print("Building AI Procurement System with Memory: XingGraph Integration...\n")
