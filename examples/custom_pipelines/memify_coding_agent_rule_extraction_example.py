...
import xinggraph
from xinggraph import memify, visualize_graph
...
async def main():
    ...
    print("Adding conversation about rules to xinggraph:\n")
    ...
    coding_rules = await xinggraph.recall(
        query_text="List me the coding rules",
        query_type=xinggraph.SearchType.CODING_RULES,
