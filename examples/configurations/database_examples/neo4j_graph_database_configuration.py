...
# This example connects to one configured Neo4j instance. XingGraph's backend
...
async def main():
    """
    Example script demonstrating how to use XingGraph with Neo4j

    This example:
    1. Configures XingGraph to use Neo4j as graph database
