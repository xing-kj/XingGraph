...
async def main():
    """
    Example script demonstrating how to use XingGraph with Amazon Neptune Analytics

    This example:
    1. Configures XingGraph to use Neptune Analytics as graph database
    2. Sets up data directories
    3. Adds sample data to XingGraph
