"""
Storage-aware cache management utilities for XingGraph.
...
from xinggraph.infrastructure.files.storage.StorageManager import StorageManager
...
async def delete_cache() -> None:
    """Delete the XingGraph cache directory."""
    cache_manager = get_cache_manager()
    await cache_manager.delete_cache()


async def get_xinggraph_cache_dir() -> str:
    """Get the base XingGraph cache directory."""
    cache_manager = get_cache_manager()
