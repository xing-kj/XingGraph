...
def graph_schema_to_graph_model(pydantic_json_schema: dict) -> BaseModel:
    ...
    config = GenerateConfig(
        ...
        additional_imports=["xinggraph.infrastructure.engine.DataPoint", "typing.Any", "typing"],
        # Set the base class for all generated models to the existing DataPoint class to
        # ensure proper integration with XingGraph's graph engine
        base_class="xinggraph.infrastructure.engine.DataPoint",
        type_overrides={"DataPoint": "xinggraph.infrastructure.engine.DataPoint"},
    )
    ...
    # the existing XingGraph DataPoint class
    ...
    module_name = "xinggraph.shared._generated_graph_models"
    ...
    # Return dynamically created Pydantic model class that can be used in xinggraph for graph creation and querying
    return graph_model
