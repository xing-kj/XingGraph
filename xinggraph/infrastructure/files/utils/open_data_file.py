...
from xinggraph.infrastructure.files.storage.FileBufferedReader import FileBufferedReader
...
async def open_data_file(
    ...
    if file_path.startswith("file://"):
        ...
        try:
            ...
            raise ImportError(
                "S3 dependencies are not installed. Please install with 'pip install xinggraph\"[aws]\"' to use S3 functionality."
            )
