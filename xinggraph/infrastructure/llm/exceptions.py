from xinggraph.exceptions.exceptions import XingGraphValidationError


class ContentPolicyFilterError(XingGraphValidationError):
    pass


class LLMPaymentRequiredError(XingGraphValidationError):
...
class LLMAPIKeyNotSetError(XingGraphValidationError):
    """
...
class UnsupportedLLMProviderError(XingGraphValidationError):
    """
...
class MissingSystemPromptPathError(XingGraphValidationError):
    def __init__(
        self,
