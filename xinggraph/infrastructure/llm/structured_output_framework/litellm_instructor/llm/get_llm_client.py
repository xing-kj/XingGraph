...
from xinggraph.infrastructure.llm.config import get_llm_context_config
from xinggraph.infrastructure.llm.exceptions import (
    LLMAPIKeyNotSetError,
    UnsupportedLLMProviderError,
)
from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.llm_interface import (
    LLMInterface,
)
from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.ollama.adapter import (
    OllamaAPIAdapter,
)

_LLM_CLIENT_CACHE_MAXSIZE = 32
_FROZEN_DICT = "__xinggraph_dict__"
_FROZEN_LIST = "__xinggraph_list__"
_FROZEN_TUPLE = "__xinggraph_tuple__"
_FROZEN_SET = "__xinggraph_set__"
...
def _get_llm_client_cached(cache_key: _LLMClientCacheKey) -> LLMInterface:
    ...
    if provider == LLMProvider.AZURE:
        from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.azure_openai.adapter import (
            AzureOpenAIAdapter,
        )
        ...
        from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.openai.adapter import (
            OpenAIAdapter,
        )
        ...
        from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.anthropic.adapter import (
            AnthropicAdapter,
        )
        ...
        from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.generic_llm_api.adapter import (
            GenericAPIAdapter,
        )
        ...
        from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.gemini.adapter import (
            GeminiAdapter,
        )
        ...
        from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.mistral.adapter import (
            MistralAdapter,
        )
        ...
        from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.bedrock.adapter import (
            BedrockAdapter,
        )
        ...
        from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.llama_cpp.adapter import (
            LlamaCppAPIAdapter,
        )
...
def get_llm_client(raise_api_key_error: bool = True) -> LLMInterface:
    ...
    # if not use value from xinggraph configuration
