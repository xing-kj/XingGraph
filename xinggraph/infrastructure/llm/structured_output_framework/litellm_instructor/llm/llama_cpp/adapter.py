...
from xinggraph.infrastructure.llm.exceptions import LLMPaymentRequiredError, is_budget_exhausted_error
...
class LlamaCppAPIAdapter(LLMInterface):
    ...
    def _init_local_mode(
        ...
        # logits buffer with no internal locking. xinggraph fans out extraction across
