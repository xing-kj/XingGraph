...
class OpenAIAdapter(GenericAPIAdapter):
    ...
    async def acreate_structured_output(
        ...
        # Some OpenAI-compatible providers (e.g. MiniMax) don't honor the
        # instructor json_schema tool-calling mode and instead emit multiple
        # parallel tool calls, which instructor rejects with
        # "Instructor does not support multiple tool calls". Force JSON-object
        # mode so the model returns the schema as content, which instructor's
        # JSON parser handles correctly.
