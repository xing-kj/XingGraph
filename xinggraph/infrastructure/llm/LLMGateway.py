...
def _inject_agent_memory(text_input: str) -> str:
    from xinggraph.modules.agent_memory import get_current_agent_memory_context
...
async def _record_session_usage_after(
    ...
    *,
    ...
    result = await coro
    try:
        from xinggraph.modules.session_lifecycle.usage_tracking import record_llm_call
    ...
    def acreate_structured_output(
        ...
        **kwargs: Any,
        ...
        if llm_config.structured_output_framework.upper() == "BAML":
            from xinggraph.infrastructure.llm.structured_output_framework.baml.baml_src.extraction import (
            ...
            from xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.get_llm_client import (
                get_llm_client,
            )
