...
from xinggraph.infrastructure.session.feedback_models import AgentTraceFeedbackSummary
...
async def generate_agent_trace_feedback(
    *,
    ...
    try:
        ...
        serialized_return_value = json.dumps(sanitized_return_value, ensure_ascii=True)
