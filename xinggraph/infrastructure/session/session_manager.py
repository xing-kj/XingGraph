...
from xinggraph.infrastructure.databases.cache.cache_db_interface import CacheDBInterface
...
from xinggraph.infrastructure.session.session_agent_trace import (
    fallback_agent_trace_feedback,
    generate_agent_trace_feedback,
)
from xinggraph.infrastructure.session.session_embeddings import (
    delete_session_qa_vector,
    delete_session_qa_vectors,
    index_session_qa,
)
from xinggraph.infrastructure.session.session_turn import (
...
from xinggraph.modules.session_lifecycle.metrics import record_session_activity
...
class SessionManager:
    ...
    def _session_usage_scope(self, user_id, session_id: str):
        ...
        from xinggraph.modules.session_lifecycle.usage_tracking import track_session_usage
    ...
    async def get_session(
        ...
        *,
        ...
        with new_span("xinggraph.session.get_session") as span:
            span.set_attribute(XINGGRAPH_SESSION_ID, session_id)
            ...
            span.set_attribute(XINGGRAPH_SESSION_ENTRY_COUNT, entry_count)
    ...
    async def update_qa(
        ...
        *,
        ...
        used_session_context_ids: Optional list of session-context entry ids served to this answer.
        """
        from xinggraph.infrastructure.locks import session_lock
