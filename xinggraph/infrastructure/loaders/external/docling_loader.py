...
from xinggraph.infrastructure.files.utils.get_file_metadata import get_file_metadata
from xinggraph.infrastructure.loaders.LoaderInterface import LoaderInterface
...
def _get_docling_converter():
    try:
        ...
        raise ImportError(
            "docling is required for DoclingLoader. Install with: pip install 'xinggraph[docling]'"
        ) from e
