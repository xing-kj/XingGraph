...
from xinggraph.modules.data.methods import create_dataset
...
from xinggraph.modules.data.methods import get_unique_dataset_id
...
async def get_or_create_dataset_database(
    ...
    async with db_engine.get_async_session() as session:
        ...
        # existing migrations; xinggraph_version is recorded for audit only.
        #
        ...
        record = DatasetDatabase(
            ...
            xinggraph_version=get_xinggraph_version(),
