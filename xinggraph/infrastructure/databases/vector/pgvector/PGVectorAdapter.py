...
from xinggraph.infrastructure.databases.relational import get_relational_engine, get_relational_config
...
class PGVectorAdapter(SQLAlchemyAdapter, VectorDBInterface):
    ...
    async def remove_belongs_to_set_tags(
        ...
        XingGraph vector collections follow the `{PascalCaseType}_{field}`
        ...
        # `schema.` prefix first, then keep only PascalCase names — xinggraph's
