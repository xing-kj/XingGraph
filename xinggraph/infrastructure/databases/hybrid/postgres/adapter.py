...
from xinggraph.infrastructure.databases.vector.pgvector.PGVectorAdapter import IndexSchema

if TYPE_CHECKING:
    from xinggraph.infrastructure.databases.graph.postgres.adapter import PostgresAdapter
    from xinggraph.infrastructure.databases.vector.pgvector.PGVectorAdapter import PGVectorAdapter
