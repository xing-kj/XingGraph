...
def create_relational_engine(
    ...
    if db_provider == "sqlite":
        ...
        try:
            ...
            raise ImportError(
                "PostgreSQL dependencies are not installed. Please install with 'pip install xinggraph\"[postgres]\"' or 'pip install xinggraph\"[postgres-binary]\"' to use PostgreSQL functionality."
            )
