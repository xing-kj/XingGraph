...
class NeptuneAnalyticsError(XingGraphSystemError):
...
class NeptuneAnalyticsConnectionError(XingGraphTransientError):
...
class NeptuneAnalyticsQueryError(XingGraphValidationError):
...
class NeptuneAnalyticsAuthenticationError(XingGraphConfigurationError):
...
class NeptuneAnalyticsConfigurationError(XingGraphConfigurationError):
...
class NeptuneAnalyticsTimeoutError(XingGraphTransientError):
...
class NeptuneAnalyticsThrottlingError(XingGraphTransientError):
...
class NeptuneAnalyticsResourceNotFoundError(XingGraphValidationError):
...
class NeptuneAnalyticsInvalidParameterError(XingGraphValidationError):
