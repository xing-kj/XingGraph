...
from xinggraph.infrastructure.databases.graph import get_graph_config
...
from xinggraph.modules.users.models import DatasetDatabase, User


NEO4J_DATASET_DATABASE_HANDLER = "neo4j"
NEO4J_SYSTEM_DATABASE = "system"
NEO4J_DATASET_DATABASE_PREFIX = "xinggraph"
    ...
    def _create_neo4j_driver(
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install xinggraph with `pip install xinggraph[neo4j]` or `uv sync --extra neo4j`."
            ) from error
