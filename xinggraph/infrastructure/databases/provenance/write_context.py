...
from xinggraph.infrastructure.databases.provenance.source_refs import make_source_ref_key
...
def data_item_id(data_item: Any) -> Any:
    ...
    file/text item, or — in memify — the ``XingGraphGraph`` itself. Only the first
