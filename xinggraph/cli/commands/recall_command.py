...
from xinggraph.cli.config import SEARCH_TYPE_CHOICES, OUTPUT_FORMAT_CHOICES
...
Otherwise, this is a memory-oriented alias for `xinggraph search`.
    """
            ...
            async def run_recall():
                try:
                    ...
                    if session_only:
                        ...
                        results = await xinggraph.recall(**recall_kwargs)
                    return results
