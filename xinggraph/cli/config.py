...
# CLI Constants
CLI_DESCRIPTION = "XingGraph CLI - Manage your knowledge graphs and cognitive processing pipelines."
DEFAULT_DOCS_URL = "https://docs.xinggraph.ai"
...
COMMAND_DESCRIPTIONS = {
    ...
    "serve": "Connect to a XingGraph instance (cloud or local)",
    ...
    "push": "Upload a local dataset's knowledge graph to XingGraph Cloud",
}
