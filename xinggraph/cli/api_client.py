"""Thin HTTP client that delegates CLI commands to a running XingGraph API server.
...
class XingGraphApiClient:
    """Wrapper around the XingGraph REST API with a shared connection pool."""
