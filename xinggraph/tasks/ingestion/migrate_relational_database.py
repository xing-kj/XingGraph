...
from xinggraph.infrastructure.databases.relational.get_migration_relational_engine import (
    get_migration_relational_engine,
)
from xinggraph.infrastructure.databases.relational.config import get_migration_config

from xinggraph.tasks.storage.index_data_points import index_data_points
from xinggraph.tasks.storage.index_graph_edges import index_graph_edges
from xinggraph.tasks.schema.ingest_database_schema import ingest_database_schema

from xinggraph.modules.engine.models import TableRow, TableType, ColumnValue
...
async def migrate_relational_database(
    ...
    Both TableType and TableRow inherit from DataPoint to maintain consistency with XingGraph data model.
    """
    ...
    # XingGraph uses this information to perform searches on the knowledge graph.
