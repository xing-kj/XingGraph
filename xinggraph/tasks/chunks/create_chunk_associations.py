...
from xinggraph.tasks.storage import index_graph_edges
...
async def create_chunk_associations(
    ...
    allowing it to be composed in xinggraph pipelines.
    ...
    if edges:
        try:
            ...
            provenance_kwargs = await graph_provenance_write_kwargs(
                graph_engine,
                ctx,
                fallback_data_id=uuid5(NAMESPACE_URL, "xinggraph:chunk-associations"),
            )
