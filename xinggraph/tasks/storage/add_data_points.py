...
from xinggraph.infrastructure.databases.unified.capabilities import EngineCapability
...
from xinggraph.infrastructure.databases.relational import get_async_session
from xinggraph.modules.graph.methods import upsert_edges, upsert_nodes
...
from xinggraph.modules.engine.models import Triplet
from xinggraph.shared.logging_utils import get_logger
from xinggraph.tasks.storage.exceptions import (
...
async def add_data_points(
    ...
    # file/text item, or the XingGraphGraph memify passes in), in which case there
    ...
    if user and dataset and data_id is not None:
        ...
        #
        # Under XINGGRAPH_DISTRIBUTED the graph write is diverted to a queue; the
