...
``xinggraph.modules.migrations.startup``.

This module is imported by ``xinggraph/__init__.py`` at package-import time, so
...
async def run_relational_migrations():
    ...
    from xinggraph.modules.migrations.startup import run_relational_migrations
...
async def run_migrations():
    ...
    from xinggraph.modules.migrations.startup import run_migrations as _run
