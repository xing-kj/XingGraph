...
from xinggraph.modules.migration.export import ExportResult, export_dataset
from xinggraph.modules.migration.snapshot import GraphSnapshot
from xinggraph.modules.observability import new_span, XINGGRAPH_DATASET_NAME
...
async def export(
    ...
    Args:
        ...
        format: One of:
            ...
            - ``"cogx"`` — re-importable archive directory
              (``xinggraph.remember(COGXArchiveSource(path))`` restores it)
    ...
    Example::
        ...
        snapshot = await xinggraph.export("main_dataset")          # typed objects
    ...
    with new_span("xinggraph.api.export") as span:
