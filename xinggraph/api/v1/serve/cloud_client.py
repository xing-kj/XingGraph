"""Remote HTTP client that proxies V2 operations to a XingGraph Cloud instance."""
...
class CloudClient:
    """Async HTTP client for a remote XingGraph Cloud tenant instance.
    ...
    # Archive uploads (xinggraph.push) plus the synchronous server-side import
