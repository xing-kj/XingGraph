...
DEFAULT_AUTH0_DOMAIN = "xinggraph.eu.auth0.com"
DEFAULT_AUTH0_AUDIENCE = "xinggraph:api"
...
def _get_auth0_domain() -> str:
    return os.getenv("XINGGRAPH_AUTH0_DOMAIN", DEFAULT_AUTH0_DOMAIN)


def _get_auth0_client_id() -> str:
    client_id = os.getenv("XINGGRAPH_AUTH0_DEVICE_CLIENT_ID", "")
    if not client_id:
        raise ValueError(
            "XINGGRAPH_AUTH0_DEVICE_CLIENT_ID must be set. "
...
def _get_auth0_audience() -> str:
    return os.getenv("XINGGRAPH_AUTH0_AUDIENCE", DEFAULT_AUTH0_AUDIENCE)
...
async def device_code_login(
    ...
    async with aiohttp.ClientSession() as session:
        ...
        print()
        print("  To authenticate with XingGraph Cloud, open this URL in your browser:")
        print()
