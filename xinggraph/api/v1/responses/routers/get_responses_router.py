...
from xinggraph.api.v1.responses.models import (
    ResponseRequest,
    ResponseBody,
    ResponseToolCall,
    ChatUsage,
...
from xinggraph.api.v1.responses.dispatch_function import dispatch_function
from xinggraph.api.v1.responses.default_tools import DEFAULT_TOOLS
...
def get_responses_router() -> APIRouter:
    ...
    async def call_openai_api_for_model(
        ...
        # TODO: Support other models (e.g. xinggraph-v1-openai-gpt-3.5-turbo, etc.)
        model = "gpt-4o"
    ...
    async def create_response(
        ...
        function calling capabilities for XingGraph operations.
        ...
        - Supports function calling with XingGraph tools
