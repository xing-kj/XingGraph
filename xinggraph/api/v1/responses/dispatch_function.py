...
from xinggraph.api.v1.responses.models import ToolCall
from xinggraph.modules.search.types import SearchType
from xinggraph.api.v1.add import add
from xinggraph.api.v1.search import search
from xinggraph.api.v1.cognify import cognify
from xinggraph.api.v1.prune import prune
...
async def dispatch_function(tool_call: Union[ToolCall, Dict[str, Any]]) -> str:
    """
    Dispatches a function call to the appropriate XingGraph function.
    """
