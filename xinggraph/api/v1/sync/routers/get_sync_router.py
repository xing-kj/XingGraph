...
from xinggraph.modules.sync.methods import get_running_sync_operations_for_user, get_sync_operation
from xinggraph.shared.utils import send_telemetry
from xinggraph.shared.logging_utils import get_logger
from xinggraph.api.v1.sync import SyncResponse
...
def get_sync_router() -> APIRouter:
    ...
    async def sync_to_cloud(
        ...
        """
        Sync local data to XingGraph Cloud.

        This endpoint triggers synchronization of local XingGraph data to your cloud instance.
        ...
        ## Cloud Sync Features
        - **Automatic Authentication**: Uses your XingGraph Cloud credentials
        ...
        from xinggraph.api.v1.sync import sync as xinggraph_sync
        ...
        try:
            ...
            sync_result = await xinggraph_sync(
                datasets=datasets,
                user=user,
            )
