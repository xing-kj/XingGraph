...
from xinggraph.modules.settings.get_settings import LLMConfig, VectorDBConfig
...
def get_settings_router() -> APIRouter:
    ...
    async def get_settings(user: User = Depends(get_authenticated_user)):
        ...
        """
        from xinggraph.modules.settings import get_settings as get_xinggraph_settings

        return get_xinggraph_settings()
    ...
    async def save_settings(
        ...
        """
        from xinggraph.modules.settings import save_llm_config, save_vector_db_config
