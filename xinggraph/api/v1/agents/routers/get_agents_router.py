...
from xinggraph.api.DTO import OutDTO
from xinggraph.modules.agents.agent_mode import register_agent, unregister_agent
from xinggraph.modules.agents.models import RegisterAgentRequest, UnregisterAgentRequest
...
def _display_email(internal_email: str) -> str:
    if "+" in internal_email:
        return internal_email.rsplit("+", 1)[0] + "@xinggraph.agent"
