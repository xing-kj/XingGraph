...
async def main():
    ...
    await xinggraph.add([ai_text_file_path], dataset_name)
    ...
    cognify_run_info = await xinggraph.cognify([dataset_name])
    ...
    remember_result = await xinggraph.remember(
        memory_text,
