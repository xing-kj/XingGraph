...
async def setup_environment():
    ...
    xinggraph.config.data_root_directory(str(base_dir / ".data_storage/test_graph_viz"))
    xinggraph.config.system_root_directory(str(base_dir / ".xinggraph_system/test_graph_viz"))
    ...
    await xinggraph.add([explanation_file_path], dataset_name="NLP")
    default_user = await get_default_user()
    nlp_cognify_result = await xinggraph.cognify(["NLP"], user=default_user)
