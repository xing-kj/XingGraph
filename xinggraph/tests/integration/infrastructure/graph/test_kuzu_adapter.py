...
from xinggraph.infrastructure.databases.graph.kuzu.adapter import KuzuAdapter
...
async def test_query_does_not_block_event_loop_during_slow_redis_acquire(kuzu_adapter, monkeypatch):
    ...
    from xinggraph.infrastructure.databases.graph.ladybug import adapter as kuzu_adapter_mod
