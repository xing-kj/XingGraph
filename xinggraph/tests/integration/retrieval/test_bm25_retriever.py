...
from xinggraph.low_level import setup as setup_databases
...
async def setup_bm25_corpus():
    ...
    xinggraph.config.system_root_directory(str(base_dir / ".xinggraph_system/test_bm25_retriever"))
    xinggraph.config.data_root_directory(str(base_dir / ".data_storage/test_bm25_retriever"))
