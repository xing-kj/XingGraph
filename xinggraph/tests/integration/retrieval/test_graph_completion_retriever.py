...
async def setup_test_environment_simple():
    ...
    system_directory_path = str(base_dir / ".xinggraph_system/test_graph_completion_context_simple")
...
async def setup_test_environment_complex():
    ...
    base_dir = pathlib.Path(__file__).parent.parent.parent.parent
    system_directory_path = str(base_dir / ".xinggraph_system/test_graph_completion_context_complex")
...
async def setup_test_environment_empty():
    ...
    system_directory_path = str(
        base_dir / ".xinggraph_system/test_get_graph_completion_context_on_empty_graph"
    )
