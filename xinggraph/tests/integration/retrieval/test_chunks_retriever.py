...
async def setup_test_environment_with_chunks_simple():
    ...
    system_directory_path = str(base_dir / ".xinggraph_system/test_chunks_retriever_context_simple")
...
async def setup_test_environment_with_chunks_complex():
    ...
    base_dir = pathlib.Path(__file__).parent.parent.parent.parent
    system_directory_path = str(base_dir / ".xinggraph_system/test_chunks_retriever_context_complex")
...
async def setup_test_environment_empty():
    ...
    base_dir = pathlib.Path(__file__).parent.parent.parent.parent
    system_directory_path = str(base_dir / ".xinggraph_system/test_chunks_retriever_context_empty")
