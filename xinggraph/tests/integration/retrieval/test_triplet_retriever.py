...
async def setup_test_environment_with_triplets():
    ...
    system_directory_path = str(base_dir / ".xinggraph_system/test_triplet_retriever_context_simple")
...
async def setup_test_environment_empty():
    ...
    system_directory_path = str(
        base_dir / ".xinggraph_system/test_triplet_retriever_context_empty_collection"
    )
