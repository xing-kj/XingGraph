...
async def setup_test_environment_with_summaries():
    ...
    system_directory_path = str(base_dir / ".xinggraph_system/test_summaries_retriever_context")
...
async def setup_test_environment_empty():
    ...
    base_dir = pathlib.Path(__file__).parent.parent.parent.parent
    system_directory_path = str(base_dir / ".xinggraph_system/test_summaries_retriever_context_empty")
