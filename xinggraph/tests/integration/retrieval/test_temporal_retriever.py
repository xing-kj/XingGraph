...
from xinggraph.modules.engine.models.Event import Event
...
async def setup_test_environment_with_events():
    ...
    system_directory_path = str(base_dir / ".xinggraph_system/test_temporal_retriever_with_events")
...
async def setup_test_environment_with_graph_data():
    ...
    base_dir = pathlib.Path(__file__).parent.parent.parent.parent
    system_directory_path = str(base_dir / ".xinggraph_system/test_temporal_retriever_with_graph")
...
async def setup_test_environment_empty():
    ...
    base_dir = pathlib.Path(__file__).parent.parent.parent.parent
    system_directory_path = str(base_dir / ".xinggraph_system/test_temporal_retriever_empty")
