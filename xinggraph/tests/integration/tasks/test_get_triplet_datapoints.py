...
async def setup_test_environment():
    ...
    xinggraph_directory_path = str(base_dir / ".xinggraph_system/test_get_triplet_datapoints_integration")
...
async def test_get_triplet_datapoints_integration(setup_test_environment):
    ...
    triplets = []
    with patch(
        "xinggraph.tasks.memify.get_triplet_datapoints.index_data_points", new_callable=AsyncMock
    ):
