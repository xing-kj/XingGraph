...
from xinggraph.tasks.storage.exceptions import InvalidDataPointsInAddDataPointsError
...
async def clean_test_environment():
    ...
    system_directory_path = str(base_dir / ".xinggraph_system/test_add_data_points_integration")
