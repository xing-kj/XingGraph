...
from xinggraph.modules.data.exceptions.exceptions import UnauthorizedDataAccessError
...
from xinggraph.modules.users.permissions.methods.authorized_give_permission_on_datasets import (
...
async def main(mock_create_structured_output: AsyncMock):
    ...
    add_marie_result = await xinggraph.add(maries_text, user=john)
