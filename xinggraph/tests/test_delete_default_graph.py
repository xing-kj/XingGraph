...
from xinggraph.modules.data.processing.document_types.TextDocument import TextDocument
...
async def main(mock_create_structured_output: AsyncMock):
    ...
    xinggraph_directory_path = os.path.join(
        pathlib.Path(__file__).parent, ".xinggraph_system/test_delete_default_graph"
    )
    ...
    # Delete John's data from xinggraph
    ...
    # Delete Marie's data from xinggraph
