...
with patch("dotenv.load_dotenv"):
    ...
    os.environ["XINGGRAPH_AGENT_MODE"] = "true"

    from fastapi.testclient import TestClient

from xinggraph.modules.agents import agent_mode
from xinggraph.modules.agents.registry import AGENT_CONFIG_NAME, clear_registered_agent_connections
...
class TestAgentsE2E:
    ...
    def test_create_sub_user_agent(self, client, headers):
        ...
        assert "@xinggraph.agent" in body["agentEmail"]
    ...
    def _patch_operations(self, owner):
        ...
        with (
            patch(
                "xinggraph.modules.agents.operations._readable_datasets_for",
                readable_datasets_for,
            ),
            patch(
                "xinggraph.modules.agents.operations._visible_user_ids",
                visible_user_ids,
            ),
            patch(
                "xinggraph.modules.agents.operations.list_persisted_agent_connections",
...
class TestAgentFullLifecycle:
    ...
    def test_full_lifecycle(self, client, headers, owner):
        ...
        reg_a = client.post(
            ...
            json={"agent_session_name": agent_a_name, "type": "api", "memory_mode": "xinggraph"},
        )
