...
class TestHashApiKey:
    ...
    @pytest.fixture(scope="class")
    def client(self):
        with patch("xinggraph.modules.users.api_key.hash_api_key.HASH_API_KEY", True):
            from xinggraph.api.client import app
    ...
    def test_api_key_is_stored_as_hash(self, client):
        ...
        from xinggraph.modules.users.api_key.hash_api_key import hash_api_key as compute_hash
