...
with patch("dotenv.load_dotenv"):
    ...
    os.environ["REQUIRE_AUTHENTICATION"] = "false"
    os.environ["ENABLE_BACKEND_ACCESS_CONTROL"] = "false"
    gau_mod = importlib.import_module("xinggraph.modules.users.methods.get_authenticated_user")
    ...
    class TestConditionalAuthenticationEndpoints:
        ...
        @patch(
            "xinggraph.api.client.REQUIRE_AUTHENTICATION",
            False,
        )
        ...
        @patch("xinggraph.api.v1.add.add")
    ...
    class TestConditionalAuthenticationBehavior:
        ...
        gsm_mod = importlib.import_module("xinggraph.modules.settings.get_settings")
    ...
    class TestConditionalAuthenticationErrorHandling:
        ...
        def test_current_environment_configuration(self, client):
            ...
            from xinggraph.modules.users.methods.get_authenticated_user import (
