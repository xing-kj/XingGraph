...
class TestXingGraphServerStart(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # Start the XingGraph server - just check if the server can start without errors
    ...
    def test_server_is_running(self):
        ...
        health_response = requests.get("http://localhost:8000/health", timeout=90)
