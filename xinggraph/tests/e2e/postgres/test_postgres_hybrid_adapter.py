...
DB_USERNAME=xinggraph, DB_PASSWORD=xinggraph, DB_NAME=xinggraph_db.
"""
...
from xinggraph.infrastructure.databases.vector.embeddings import get_embedding_engine
from xinggraph.infrastructure.databases.hybrid.postgres.adapter import PostgresHybridAdapter
...
async def adapter():
    ...
    db_username = os.environ.get("DB_USERNAME", "xinggraph")
    db_password = os.environ.get("DB_PASSWORD", "xinggraph")
    db_host = os.environ.get("DB_HOST", "localhost")
    db_port = os.environ.get("DB_PORT", "5432")
    db_name = os.environ.get("DB_NAME", "xinggraph_db")
    ...
    # Enable pgvector extension -- normally done by xinggraph's create_db_and_tables()
...
async def test_hybrid_payload_matches_separate_path(adapter):
    ...
    from xinggraph.tasks.storage.index_graph_edges import index_graph_edges
