...
Requires a running Postgres instance. Connection defaults:
  DB_HOST=localhost, DB_PORT=5432, DB_USERNAME=xinggraph,
  DB_PASSWORD=xinggraph, DB_NAME=xinggraph_db
...
async def adapter():
    ...
    """
    username = os.environ.get("DB_USERNAME", "xinggraph")
    password = os.environ.get("DB_PASSWORD", "xinggraph")
    host = os.environ.get("DB_HOST", "localhost")
    port = os.environ.get("DB_PORT", "5432")
    database = os.environ.get("DB_NAME", "xinggraph_db")
