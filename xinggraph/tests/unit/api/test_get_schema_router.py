...
inventory_module = import_module("xinggraph.api.v1.visualize.get_schema_inventory")
router_module = import_module("xinggraph.api.v1.visualize.routers.get_schema_router")
