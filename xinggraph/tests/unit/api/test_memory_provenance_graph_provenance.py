...
from xinggraph.infrastructure.databases.provenance import EdgeIdentity, make_source_ref_key

provenance_module = importlib.import_module("xinggraph.api.v1.visualize.memory_provenance")
...
def _patch_empty_relational(monkeypatch):
    import xinggraph.infrastructure.databases.relational as relational_module
...
async def test_read_memory_graph_provenance_builds_memory_payload(monkeypatch):
    ...
    import xinggraph.infrastructure.databases.provenance.markers as markers_module
    import xinggraph.infrastructure.databases.unified as unified_module
