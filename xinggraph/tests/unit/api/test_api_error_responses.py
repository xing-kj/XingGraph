...
from xinggraph.modules.pipelines.models import PipelineRunErrored, PipelineRunCompleted
...
from xinggraph.api.v1.add.routers.get_add_router import get_add_router
from xinggraph.api.v1.cognify.routers.get_cognify_router import get_cognify_router
from xinggraph.api.v1.memify.routers.get_memify_router import get_memify_router
from xinggraph.api.v1.remember.routers.get_remember_router import get_remember_router
from xinggraph.api.v1.search.routers.get_search_router import get_search_router
from xinggraph.api.v1.update.routers.get_update_router import get_update_router
...
class TestAddEndpoint:
    ...
    def test_add_pipeline_errored_returns_500(self, client):
        import xinggraph.api.v1.add as add_pkg
    ...
    def test_add_success_returns_200(self, client):
        ...
        resp = client.post(
            "/add",
            data={"datasetName": "test_dataset"},
            files={"data": ("test.txt", b"XingGraph is an AI memory platform.", "text/plain")},
        )
...
class TestRememberEndpoint:
    def test_remember_passes_chunk_size(self, client, monkeypatch):
        remember_pkg = importlib.import_module("xinggraph.api.v1.remember")
...
class TestCognifyEndpoint:
    ...
    def test_cognify_pipeline_errored_returns_500(self, client):
        import xinggraph.api.v1.cognify as cognify_pkg
...
class TestSearchEndpoint:
    def test_search_permission_denied_returns_403(self, client):
        import xinggraph.api.v1.search as search_pkg
    ...
    def test_search_success_returns_200(self, client):
        ...
        search_pkg.search = AsyncMock(
            return_value=[
                {
                    "search_result": "XingGraph is an AI memory platform.",
        ...
        body = resp.json()
        assert len(body) == 1
        assert "XingGraph" in body[0]["search_result"]
...
class TestMemifyEndpoint:
    ...
    def test_memify_pipeline_errored_returns_500(self, client):
        import xinggraph.modules.memify as memify_pkg
...
class TestUpdateEndpoint:
    def test_update_pipeline_errored_returns_500(self, client):
        import xinggraph.api.v1.update as update_pkg
