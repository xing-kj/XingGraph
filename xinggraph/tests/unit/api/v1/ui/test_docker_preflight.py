"""Tests for Docker daemon preflight checks in xinggraph.api.v1.ui.ui."""

import subprocess
from unittest.mock import patch, MagicMock, call

from xinggraph.api.v1.ui.ui import _check_docker_available
...
class TestStartUiDockerIntegration:
    ...
    @patch("xinggraph.api.v1.ui.ui.prompt_user_for_download", return_value=False)
    @patch("xinggraph.api.v1.ui.ui.find_frontend_path", return_value=None)
    @patch("xinggraph.api.v1.ui.ui._check_docker_available", return_value=(False, "no docker"))
    @patch("xinggraph.api.v1.ui.ui._check_required_ports", return_value=(True, []))
    def test_skips_mcp_docker_pull_when_docker_unavailable(
        ...
        from xinggraph.api.v1.ui.ui import start_ui
