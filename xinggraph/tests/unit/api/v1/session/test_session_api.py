...
def _session_module():
    ...
    import xinggraph.api.v1.session  # noqa: F401 - ensures session.py is in sys.modules
...
class TestResolveUser:
    ...
    async def test_get_session_uses_explicit_user(self, sm):
        from xinggraph.api.v1.session.session import get_session
    ...
    async def test_add_feedback_uses_explicit_user(self, sm):
        from xinggraph.api.v1.session.session import add_feedback
    ...
    async def test_delete_feedback_uses_resolved_user(self, session_user_ctx, sm):
        from xinggraph.api.v1.session.session import delete_feedback
...
class TestAddFrequencyWeights:
    ...
    @pytest.mark.asyncio
    async def test_returns_true_on_success(self, session_user_ctx, sm):
        from xinggraph.api.v1.session.session import add_frequency_weights
...
class TestSessionNamespace:
    ...
    def test_session_has_get_session_add_feedback_delete_feedback(self):
        """xinggraph.session exposes get_session, add_feedback, delete_feedback, add_frequency_weights."""
        from xinggraph.api.v1.session import session
    ...
    def test_session_qa_entry_exported(self):
        ...
        from xinggraph.api.v1.session import SessionQAEntry as Exported
    ...
    def test_all_exported(self):
        ...
        from xinggraph.api.v1.session import __all__
