...
def test_client():
    from xinggraph.api.v1.datasets.routers.get_datasets_router import get_datasets_router
...
def client(test_client):
    ...
    datasets_router_module = importlib.import_module(
        "xinggraph.api.v1.datasets.routers.get_datasets_router"
    )
...
def _patch_raw_download_dependencies(
    ...
    import xinggraph.modules.data.methods as data_methods_module
...
def test_get_raw_data_s3_streams_bytes_without_s3_dependency(client, monkeypatch):
    ...
    import xinggraph.infrastructure.files.utils.open_data_file as open_data_file_module
