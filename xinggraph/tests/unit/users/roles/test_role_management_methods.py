...
from xinggraph.modules.users.roles.methods.delete_role import delete_role
from xinggraph.modules.users.roles.methods.remove_user_from_role import remove_user_from_role

_delete_role_mod = importlib.import_module("xinggraph.modules.users.roles.methods.delete_role")
_remove_user_mod = importlib.import_module(
    "xinggraph.modules.users.roles.methods.remove_user_from_role"
)
