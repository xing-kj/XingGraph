...
from xinggraph.modules.ontology.exceptions import OntologyInitializationError
from xinggraph.modules.ontology.models import AttachedOntologyNode
from xinggraph.modules.ontology.get_default_ontology_resolver import get_default_ontology_resolver
...
def test_fuzzy_matching_strategy_exact_match():
    ...
    from xinggraph.modules.ontology.matching_strategies import FuzzyMatchingStrategy
...
def test_rdflib_ontology_resolver_uses_matching_strategy():
    ...
    result = resolver.find_closest_match("Audi", "individuals")
    # Exact match "audi" is found in the primary lookup before custom strategy runs
    assert result == "audi"
...
def test_get_ontology_resolver_from_env_success():
    ...
    from xinggraph.modules.ontology.get_default_ontology_resolver import get_ontology_resolver_from_env
    from xinggraph.modules.ontology.rdf_xml.RDFLibOntologyResolver import RDFLibOntologyResolver
    from xinggraph.modules.ontology.matching_strategies import FuzzyMatchingStrategy
