...
from xinggraph.modules.engine.utils import generate_edge_name, generate_node_id
from xinggraph.modules.graph.utils.expand_with_nodes_and_edges import _create_edge_key
from xinggraph.shared.data_models import Edge as KGEdge
from xinggraph.shared.data_models import KnowledgeGraph, Node

retrieve_module = importlib.import_module("xinggraph.modules.graph.utils.retrieve_existing_edges")
