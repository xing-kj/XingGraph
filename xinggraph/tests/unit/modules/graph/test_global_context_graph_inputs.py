...
import xinggraph.modules.graph.methods.get_global_context_graph_inputs as gci
from xinggraph.modules.graph.methods.get_global_context_graph_inputs import (
    DatasetEntityCounts,
...
from xinggraph.tasks.memify.global_context_index.bucketing.graph.inputs import (
...
async def test_graph_bucketing_input_provider_computes_idf_weights(monkeypatch):
    ...
    monkeypatch.setattr(
        "xinggraph.tasks.memify.global_context_index.bucketing.graph.inputs."
        "load_dataset_graph_entity_input",
