...
from xinggraph.infrastructure.databases.cache.models import SessionAgentTraceEntry
from xinggraph.modules.users.models import User
from xinggraph.tasks.memify.extract_agent_trace_feedbacks import extract_agent_trace_feedbacks

extract_agent_trace_feedbacks_module = sys.modules[
    "xinggraph.tasks.memify.extract_agent_trace_feedbacks"
]
...
async def test_extract_agent_trace_feedbacks_rejects_non_boolean_raw_trace_content(mock_user):
    ...
    with (
        ...
        with pytest.raises(XingGraphSystemError, match="raw_trace_content must be a boolean"):
