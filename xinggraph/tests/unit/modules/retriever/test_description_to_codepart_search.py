...
async def test_code_description_to_code_part_no_results():
    ...
    with (
        patch(
            "xinggraph.modules.retrieval.utils.description_to_codepart_search.get_vector_engine_async",
            return_value=mock_vector_engine,
        ),
        patch(
            "xinggraph.modules.retrieval.utils.description_to_codepart_search.get_graph_engine",
            return_value=AsyncMock(),
        ),
        patch(
            "xinggraph.modules.retrieval.utils.description_to_codepart_search.XingGraphGraph",
            return_value=AsyncMock(),
        ),
    ):
        from xinggraph.modules.retrieval.utils.description_to_codepart_search import (
