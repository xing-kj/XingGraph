...
from xinggraph.modules.visualization.embedding_join import (
...
def test_default_engine_path_awaits_async_factory(monkeypatch):
    ...
    import xinggraph.infrastructure.databases.vector as vector_package
...
def test_join_logs_hit_rate(monkeypatch):
    ...
    from xinggraph.modules.visualization import embedding_join
