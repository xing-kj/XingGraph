...
class TestGraphSummaryCompletionRetriever:
    ...
    async def test_resolve_edges_to_text_calls_super_and_summarizes(self, mock_edge):
        ...
        with (
            patch(
                "xinggraph.modules.retrieval.graph_completion_retriever.GraphCompletionRetriever.resolve_edges_to_text",
                new_callable=AsyncMock,
                return_value="Resolved edges text",
            ) as mock_super_resolve,
            patch(
                "xinggraph.modules.retrieval.graph_summary_completion_retriever.summarize_text",
                new_callable=AsyncMock,
