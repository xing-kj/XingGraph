...
class TestGenerateCompletion:
    ...
    async def test_generate_completion_with_system_prompt(self):
        ...
        with (
            patch(
                "xinggraph.modules.retrieval.utils.completion.render_prompt",
                return_value="User prompt text",
            ),
            patch(
                "xinggraph.modules.retrieval.utils.completion.LLMGateway.acreate_structured_output",
    ...
    async def test_generate_completion_without_system_prompt(self):
        ...
        with (
            ...
            patch(
                "xinggraph.modules.retrieval.utils.completion.read_query_prompt",
...
class TestSummarizeText:
    ...
    async def test_summarize_text_with_system_prompt(self):
        ...
        with patch(
            ...
            from xinggraph.modules.retrieval.utils.completion import summarize_text
...
class TestGenerateSessionCompletionWithOptionalSummary:
    ...
    async def test_summarize_context_true_returns_summary_and_no_feedback_result(self):
        ...
        with (
            ...
            patch(
                "xinggraph.modules.retrieval.utils.completion.summarize_text",
                new_callable=AsyncMock,
