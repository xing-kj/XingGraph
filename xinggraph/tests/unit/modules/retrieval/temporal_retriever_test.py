...
from xinggraph.tasks.temporal_graph.models import QueryInterval, Timestamp
...
async def test_get_context_with_time_range(mock_graph_engine, mock_vector_engine):
    ...
    with (
        ...
        patch(
            "xinggraph.modules.retrieval.temporal_retriever.get_unified_engine",
...
async def test_extract_time_from_query_relative_path():
    ...
    with (
        patch("xinggraph.modules.retrieval.temporal_retriever.os.path.isabs", return_value=False),
        patch("xinggraph.modules.retrieval.temporal_retriever.datetime") as mock_datetime,
        patch(
            "xinggraph.modules.retrieval.temporal_retriever.render_prompt",
...
async def test_extract_time_from_query_absolute_path():
    ...
    with (
        patch("xinggraph.modules.retrieval.temporal_retriever.os.path.isabs", return_value=True),
        patch(
            "xinggraph.modules.retrieval.temporal_retriever.os.path.dirname",
            return_value="/absolute/path/to",
        ),
        patch(
            "xinggraph.modules.retrieval.temporal_retriever.os.path.basename",
