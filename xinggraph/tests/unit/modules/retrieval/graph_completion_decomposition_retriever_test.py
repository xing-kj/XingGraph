...
from xinggraph.modules.retrieval.utils.query_decomposition import (
...
async def test_decompose_query_falls_back_to_original_query_on_failure():
    ...
    with (
        patch(
            "xinggraph.modules.retrieval.graph_completion_decomposition_retriever.read_query_prompt",
            return_value="Decomposition prompt",
        ),
        patch(
            "xinggraph.modules.retrieval.graph_completion_decomposition_retriever.LLMGateway.acreate_structured_output",
...
async def test_combined_mode_uses_get_triplets_batch_and_returns_flat_deduped_edges():
    ...
    with (
        patch(
            "xinggraph.modules.retrieval.graph_completion_decomposition_retriever.get_unified_engine",
            new_callable=AsyncMock,
...
async def test_combined_mode_final_completion_uses_original_query():
    ...
    with (
        ...
        patch(
            "xinggraph.modules.retrieval.graph_completion_retriever.resolve_edges_to_text",
            new_callable=AsyncMock,
            return_value="Merged context",
        ),
        patch(
            "xinggraph.modules.retrieval.graph_completion_retriever.generate_completion",
            new_callable=AsyncMock,
...
async def test_answer_per_subquery_mode_preserves_order_and_runs_subquery_completion():
    ...
    with (
        ...
        patch(
            "xinggraph.modules.retrieval.graph_completion_decomposition_retriever.generate_completion",
            new_callable=AsyncMock,
...
async def test_get_completion_from_context_without_context_uses_state_objects():
    ...
    with (
        ...
        patch(
            "xinggraph.modules.retrieval.graph_completion_retriever.GraphCompletionRetriever.get_completion_from_context",
            new_callable=AsyncMock,
            return_value=["Final answer"],
