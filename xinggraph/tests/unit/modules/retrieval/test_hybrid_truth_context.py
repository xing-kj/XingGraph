...
from xinggraph.context_global_variables import current_dataset_id
from xinggraph.modules.retrieval.hybrid_retriever import HybridRetriever
from xinggraph.modules.truth_subspace.models import TruthCentroidPayload
...
async def test_truth_context_loads_exact_centroid_slots_for_current_dataset():
    ...
    try:
        with (
            patch(
                "xinggraph.modules.retrieval.hybrid_retriever.load_centroids",
                centroid_loader,
            ),
            patch.object(
                retriever,
