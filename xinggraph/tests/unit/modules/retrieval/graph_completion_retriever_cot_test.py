...
async def test_get_triplets_inherited(mock_edge):
    ...
    with patch(
        "xinggraph.modules.retrieval.graph_completion_retriever.brute_force_triplet_search",
...
async def test_run_cot_completion_round_zero(mock_edge):
    ...
    with (
        ...
        patch(
            "xinggraph.modules.retrieval.utils.completion.generate_completion",
            return_value="Generated answer",
        ),
        patch(
            "xinggraph.modules.retrieval.graph_completion_cot_retriever._as_answer_text",
            return_value="Generated answer",
        ),
        patch(
            "xinggraph.modules.retrieval.graph_completion_cot_retriever.render_prompt",
            return_value="Rendered prompt",
        ),
        patch(
            "xinggraph.modules.retrieval.graph_completion_cot_retriever.read_query_prompt",
...
async def test_get_completion(mock_edge):
    ...
    with (
        patch(
            "xinggraph.modules.retrieval.graph_completion_retriever.get_unified_engine",
        ...
        patch(
            "xinggraph.modules.retrieval.graph_completion_cot_retriever.generate_completion_batch",
            new_callable=AsyncMock,
            return_value=["Generated answer"],
        ),
        patch(
