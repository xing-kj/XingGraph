...
from xinggraph.modules.data.processing.document_types import DltRowDocument, TextDocument

summarize_text_module = importlib.import_module("xinggraph.tasks.summarization.summarize_text")
