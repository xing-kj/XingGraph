...
from xinggraph.modules.pipelines.tasks.task import BoundTask
...
class TestDrop:
    ...
    def test_drop_is_singleton(self):
        from xinggraph.pipelines.types import _Drop
...
class TestFieldAnnotations:
    def test_embeddable_auto_derives_index_fields(self):
        from xinggraph.infrastructure.engine import DataPoint, Embeddable
    ...
    def test_dedup_auto_derives_identity_fields(self):
        from xinggraph.infrastructure.engine import DataPoint, Dedup
    ...
    def test_dedup_generates_deterministic_id(self):
        from xinggraph.infrastructure.engine import DataPoint, Embeddable, Dedup
    ...
    def test_llm_context_marker_exists(self):
        from xinggraph.infrastructure.engine import DataPoint, LLMContext
...
class TestLegacyCompat:
    def test_task_import(self):
        from xinggraph.pipelines import Task

        assert Task is not None

    def test_run_tasks_import(self):
        from xinggraph.pipelines import run_tasks

        assert callable(run_tasks)

    def test_run_pipeline_import(self):
        from xinggraph.pipelines import run_pipeline
