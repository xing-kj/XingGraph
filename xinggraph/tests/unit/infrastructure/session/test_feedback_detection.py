...
from xinggraph.infrastructure.session.feedback_detection import detect_feedback
...
class TestDetectFeedback:
    ...
    async def test_detect_feedback_llm_returns_query_to_answer(self):
        ...
        with (
            patch(
                "xinggraph.infrastructure.session.feedback_detection.read_query_prompt",
                return_value="System prompt",
            ),
            patch(
                "xinggraph.infrastructure.session.feedback_detection.LLMGateway.acreate_structured_output",
