...
from xinggraph.tests.unit.infrastructure.databases.provenance.fakes import FakeGraphVectorStore
...
def test_unsupported_provenance_capability_does_not_log_by_default(monkeypatch):
    ...
    monkeypatch.setattr("xinggraph.exceptions.exceptions.logger.error", fake_error)
