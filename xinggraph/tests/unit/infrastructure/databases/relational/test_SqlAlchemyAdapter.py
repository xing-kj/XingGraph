...
from xinggraph.infrastructure.databases.relational.sqlalchemy.SqlAlchemyAdapter import (
    SQLAlchemyAdapter,
)
...
class TestSQLAlchemyAdapterConnectArgs:
    ...
    @patch(
        "xinggraph.infrastructure.databases.relational.sqlalchemy.SqlAlchemyAdapter.create_async_engine"
    )
    ...
    @patch("xinggraph.infrastructure.databases.relational.sqlalchemy.SqlAlchemyAdapter.event")
    @patch(
        "xinggraph.infrastructure.databases.relational.sqlalchemy.SqlAlchemyAdapter.create_async_engine"
    )
...
class TestSQLAlchemyAdapterSqliteConcurrencyModel:
    ...
    tempting "optimizations" both look like they fix the lock but break xinggraph:
