...
try:
    from xinggraph.infrastructure.databases.vector.lancedb.LanceDBAdapter import LanceDBAdapter
...
async def test_pgvector_search_returns_raw_distance(monkeypatch):
    import xinggraph.infrastructure.databases.vector.pgvector.PGVectorAdapter as pg_module
