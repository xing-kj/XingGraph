...
/ `evict_graph_engine`) in subprocess mode — no LLM or full xinggraph config needed.
"""
...
async def test_handle_reresolves_after_eviction(tmp_path):
    ...
    from xinggraph.infrastructure.databases.graph.get_graph_engine import _GraphEngineHandle
