...
- DATABASE_MAX_LRU_CACHE_SIZE: Maximum concurrent dataset operations
  (default: 128, sourced from xinggraph.shared.lru_cache)
"""
...
DATASET_QUEUE_MODULE = "xinggraph.infrastructure.databases.dataset_queue"
...
class TestReleaseSlotFor:
    ...
    async def test_teardown_fires_for_single_holder(self):
        from xinggraph.infrastructure.databases.dataset_queue.queue import DatasetQueue
