...
from xinggraph.infrastructure.llm.config import LLMConfig, get_llm_context_config
from xinggraph.infrastructure.llm.LLMGateway import _record_session_usage_after
...
async def test_record_session_usage_after_reads_the_context_config(monkeypatch):
    ...
    monkeypatch.setattr(
        "xinggraph.modules.session_lifecycle.usage_tracking.record_llm_call", record_llm_call
    )
