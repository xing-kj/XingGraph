...
async def test_openai_adapter_raises_payment_required_on_402(monkeypatch):
    import xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.generic_llm_api.adapter as generic_mod
    import xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.openai.adapter as openai_mod
...
async def test_anthropic_adapter_raises_payment_required_on_402(monkeypatch):
    ...
    monkeypatch.setattr(
        "xinggraph.infrastructure.llm.structured_output_framework.litellm_instructor.llm.anthropic.adapter.instructor.patch",
