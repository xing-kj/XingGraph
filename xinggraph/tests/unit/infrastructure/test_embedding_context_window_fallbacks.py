...
async def test_ollama_embedding_splits_batch_on_context_window_error():
    with patch(
        "xinggraph.infrastructure.databases.vector.embeddings.OllamaEmbeddingEngine."
...
async def test_fastembed_splits_batch_on_context_window_error():
    ...
    with (
        patch(
            "xinggraph.infrastructure.databases.vector.embeddings.FastembedEmbeddingEngine."
