...
with patch.dict(
    sys.modules,
    {
        ...
        "xinggraph.eval_framework.evaluation.metrics.context_coverage": MagicMock(),
    },
):
    from xinggraph.eval_framework.evaluation.deep_eval_adapter import DeepEvalAdapter
