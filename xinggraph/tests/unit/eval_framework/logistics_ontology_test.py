...
from xinggraph.eval_framework.benchmark_adapters.logistics_system_utils.ontology import (
...
def test_add_packages_to_world_retries_until_package_is_deliverable():
    ...
    with (
        patch(
            "xinggraph.eval_framework.benchmark_adapters.logistics_system_utils.ontology._compatible_user_retailer_pairs",
            return_value=[(user, retailer, undeliverable_package.shipping_range)],
        ),
        patch(
            "xinggraph.eval_framework.benchmark_adapters.logistics_system_utils.ontology._seed_package",
            side_effect=[undeliverable_package, deliverable_package],
        ),
        patch(
            "xinggraph.eval_framework.benchmark_adapters.logistics_system_utils.ontology.DeliveryRuleEngine.evaluate",
            side_effect=[
