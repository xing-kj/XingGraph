...
from xinggraph.modules.migration.loader import record_data_id, translate_records
from xinggraph.modules.migration.sources import (
    COGXArchiveSource,
    GraphitiSource,
    LettaSource,
    Mem0Source,
...
class TestFormatEmitters:
    ...
    def test_cypher(self, tmp_path):
        ...
        assert "CREATE INDEX IF NOT EXISTS FOR (n:XingGraphNode) ON (n.id);" in script
        assert 'MERGE (n:XingGraphNode {id: "id-1"}) SET n:`Entity`' in script
