...
from xinggraph.modules.migration.cogx import COGXArchiveWriter, COGXEntity, COGXFact
...
def _packed_archive_bytes(tmp_path, name="sample"):
    ...
    with COGXArchiveWriter(archive_dir, source_system="xinggraph") as writer:
...
def fake_import(monkeypatch):
    ...
    import xinggraph.modules.migration as migration_pkg
...
class TestCogxArchiveHappyPath:
    def test_single_archive_import(self, client, fake_import, tmp_path):
        ...
        from xinggraph.modules.migration import COGXArchiveSource
...
class TestCogxArchiveDatasetResolution:
    def test_dataset_id_only_resolves_name(self, client, fake_import, monkeypatch, tmp_path):
        import xinggraph.modules.pipelines.layers.resolve_authorized_user_datasets as resolve_module
