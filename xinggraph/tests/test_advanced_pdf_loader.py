...
from xinggraph.infrastructure.loaders.external.advanced_pdf_loader import AdvancedPdfLoader

advanced_pdf_loader_module = sys.modules.get(
    "xinggraph.infrastructure.loaders.external.advanced_pdf_loader"
)
...
@pytest.mark.asyncio
@patch("xinggraph.infrastructure.loaders.external.advanced_pdf_loader.open", new_callable=mock_open)
@patch(
    "xinggraph.infrastructure.loaders.external.advanced_pdf_loader.get_file_metadata",
    new_callable=AsyncMock,
)
@patch("xinggraph.infrastructure.loaders.external.advanced_pdf_loader.get_storage_config")
@patch("xinggraph.infrastructure.loaders.external.advanced_pdf_loader.get_file_storage")
@patch("xinggraph.infrastructure.loaders.external.advanced_pdf_loader.PyPdfLoader")
@patch("xinggraph.infrastructure.loaders.external.advanced_pdf_loader.partition_pdf")
...
@patch("xinggraph.infrastructure.loaders.external.advanced_pdf_loader.PyPdfLoader")
@patch(
    "xinggraph.infrastructure.loaders.external.advanced_pdf_loader.partition_pdf",
