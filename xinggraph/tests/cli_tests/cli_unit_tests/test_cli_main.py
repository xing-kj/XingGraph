...
from xinggraph.cli._xinggraph import main, _discover_commands, _create_parser
...
class TestCliMain:
    ...
    @patch("xinggraph.cli._xinggraph._create_parser")
    ...
    @patch("xinggraph.cli._xinggraph._create_parser")
    @patch("xinggraph.cli.debug.is_debug_enabled")
    ...
    def test_version_argument(self):
        ...
        assert "xinggraph" in version_action.version
...
class TestDebugAction:
    ...
    @patch("xinggraph.cli.debug.enable_debug")
    @patch("xinggraph.cli.echo.note")
    def test_debug_action_call(self, mock_note, mock_enable_debug):
        """Test that DebugAction enables debug mode"""
        from xinggraph.cli._xinggraph import DebugAction
