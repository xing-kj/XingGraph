"""Unit tests for xinggraph.cli.api_dispatch."""
...
from xinggraph.cli.api_dispatch import can_dispatch, dispatch, SUPPORTED_COMMANDS
...
class TestDispatchRouting:
    @patch("xinggraph.cli.api_dispatch.XingGraphApiClient")
    ...
    def test_health_probe_failure_gives_clear_message(self, MockClient):
        ...
        with pytest.raises(RuntimeError, match="Cannot connect to XingGraph API"):
            dispatch(args)
...
class TestUserIdHeader:
    ...
    def test_user_id_passed_as_header(self, MockClient):
        ...
        # Check that XingGraphApiClient was constructed with the X-User-Id header
