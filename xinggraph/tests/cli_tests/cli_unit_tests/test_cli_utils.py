...
from xinggraph.cli.config import (
    CLI_DESCRIPTION,
    DEFAULT_DOCS_URL,
...
from xinggraph.cli._xinggraph import _discover_commands
...
class TestCliConfig:
    ...
    def test_cli_description_exists(self):
        ...
        assert "xinggraph" in CLI_DESCRIPTION.lower()
    ...
    def test_default_docs_url_exists(self):
        ...
        assert "xinggraph.ai" in DEFAULT_DOCS_URL
