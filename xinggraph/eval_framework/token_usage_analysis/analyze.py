"""Estimate the token cost of xinggraph memory vs. full-context prompting.

Measure a few representative chunks of an input, then extrapolate the
full-context-vs-xinggraph cost comparison to the whole corpus. See README.md.
"""
...
def main() -> None:
    load_dotenv(REPO_ROOT / ".env")  # xinggraph reads .env; also exposes provider keys
    args = parse_args()
