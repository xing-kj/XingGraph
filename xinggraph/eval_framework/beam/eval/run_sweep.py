"""Run BEAM answer/eval sweep against an already-ingested XingGraph corpus."""
...
from xinggraph.eval_framework.beam.eval.sweep import (  # noqa: E402
...
from xinggraph.eval_framework.benchmark_adapters.beam_adapter import (  # noqa: E402
    load_beam_row,
    parse_beam_probing_questions,
    truncate_beam_chat_batches,
)
from xinggraph.eval_framework.reporting.io import write_json  # noqa: E402
from xinggraph.eval_framework.sweeps.retriever_sweep_runner import (  # noqa: E402
...
def configure_quiet_logging() -> None:
    ...
    for logger_name in ("xinggraph", "eval_framework", "evaluation", "retrieval"):
...
def _write_run_info(
    ...
    run_info = {
        "entrypoint": "xinggraph/eval_framework/beam/eval/run_sweep.py",
        ...
        "resolved_run": {
            ...
            "dataset_source": "existing_xinggraph_ingestion",
