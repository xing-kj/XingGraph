...
from xinggraph.eval_framework.beam.eval.metrics.beam_rubric import BEAMRubricMetric
from xinggraph.eval_framework.beam.eval.metrics.kendall_tau import KendallTauMetric
...
class BeamEvalAdapter(BaseEvalAdapter):
    ...
    def __init__(self, max_concurrent_evaluations: Optional[int] = None):
        env_override = os.getenv("XINGGRAPH_BEAM_EVAL_MAX_CONCURRENT")
    ...
    def _build_test_case(self, answer: Dict[str, Any]) -> BeamLLMTestCase:
        ...
        return BeamLLMTestCase(
            ...
            if "retrieval_context" in answer
            else None,
