...
from xinggraph.eval_framework.benchmark_adapters.base_benchmark_adapter import (
    BaseBenchmarkAdapter,
)
from xinggraph.eval_framework.benchmark_adapters.logistics_system_utils.corpus_generator.narrativize_corpus import (
    PACKAGE_FOLDER,
