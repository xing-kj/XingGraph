...
from xinggraph.eval_framework.benchmark_adapters.logistics_system_utils.entities.package import (
    Package,
...
from xinggraph.eval_framework.benchmark_adapters.logistics_system_utils.entities.user import (
    User,
