...
Usage:
    uv run python xinggraph/eval_framework/run_beam_eval.py
"""

import asyncio

from xinggraph.shared.logging_utils import get_logger
from xinggraph.eval_framework.eval_config import EvalConfig
from xinggraph.eval_framework.corpus_builder.run_corpus_builder import run_corpus_builder
from xinggraph.eval_framework.answer_generation.run_question_answering_module import (
    run_question_answering,
)
from xinggraph.eval_framework.evaluation.run_evaluation_module import run_evaluation
from xinggraph.eval_framework.metrics_dashboard import create_dashboard
...
async def main():
    ...
    # Step 1: Build corpus (ingest conversation into xinggraph)
