...
class EvaluatorAdapter(Enum):
    ...
    DEEPEVAL = ("DeepEval", "xinggraph.eval_framework.evaluation.deep_eval_adapter", "DeepEvalAdapter")
    BEAM = ("BeamEval", "xinggraph.eval_framework.beam.eval.beam_eval_adapter", "BeamEvalAdapter")
    DIRECT_LLM = (
        "DirectLLM",
        "xinggraph.eval_framework.evaluation.direct_llm_eval_adapter",
