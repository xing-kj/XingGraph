...
from xinggraph.context_global_variables import session_user, set_database_global_context_variables
...
from xinggraph.infrastructure.session.session_context_builder import coerce_active_context_entries
from xinggraph.infrastructure.session.session_context_models import SessionContextEntry
...
from xinggraph.modules.truth_subspace.constants import truth_session_node_set
from xinggraph.modules.users.methods import get_default_user
from xinggraph.modules.users.models import User
from xinggraph.shared.async_utils import gather_with_concurrency_limit
...
async def publish_distilled_lessons(
    ...
    # Imported lazily to avoid a circular import through the xinggraph package root.
