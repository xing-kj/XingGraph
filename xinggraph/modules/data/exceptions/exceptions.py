...
class UnstructuredLibraryImportError(XingGraphConfigurationError):
    def __init__(
        self,
...
class UnauthorizedDataAccessError(XingGraphValidationError):
    def __init__(
        self,
...
class DatasetTypeError(XingGraphValidationError):
    def __init__(
        self,
...
class InvalidTableAttributeError(XingGraphValidationError):
    def __init__(
        self,
