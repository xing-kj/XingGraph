...
active_skills_var: ContextVar[Dict[str, Skill]] = ContextVar("xinggraph_active_skills", default={})

opened_skills_var: ContextVar[Optional[Set[str]]] = ContextVar("xinggraph_opened_skills", default=None)
