...
from xinggraph.modules.engine.models import Tool
...
from xinggraph.modules.tools.registry import register_builtin_tool
...
TOOL = Tool(
    ...
    handler_ref="xinggraph.modules.tools.builtin.memory_search.handler",
