...
from xinggraph.memory.entries import SkillRunEntry
from xinggraph.context_global_variables import set_database_global_context_variables
from xinggraph.modules.engine.models import (
    CandidateSkill,
    NodeSet,
    SkillRun,
    ToolCall,
...
logger = get_logger("xinggraph.tools.skill_runs")
...
def _skill_run_data_id(dataset_id: UUID, run_id: str) -> UUID:
    ...
    return uuid5(NAMESPACE_URL, f"xinggraph:skill-runs:{dataset_id}:{run_id}")
