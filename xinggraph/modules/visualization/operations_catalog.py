"""Catalog of xinggraph operations that transform the knowledge graph.
...
Curated from the implementation:
  ...
  * xinggraph/modules/memify/memify.py + xinggraph/memify_pipelines/*
  * xinggraph/api/v1/improve/improve.py
  * xinggraph/api/v1/forget/forget.py
  * xinggraph/tasks/codingagents/coding_rule_associations.py
