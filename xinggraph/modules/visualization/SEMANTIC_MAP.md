...
It reuses vectors xinggraph already stores during `cognify`; nothing is
...
The production render path (`xinggraph_network_visualization`) builds the tab in
...
```python
import xinggraph
from xinggraph.api.v1.visualize.visualize import visualize_graph

await xinggraph.add("...your text...")
