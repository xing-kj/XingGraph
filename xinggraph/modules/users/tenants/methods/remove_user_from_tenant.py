...
from xinggraph.modules.users.models.ACL import ACL
from xinggraph.modules.users.models.Role import Role
from xinggraph.modules.users.models.UserRole import UserRole
from xinggraph.modules.users.models.UserTenant import UserTenant
from xinggraph.modules.users.permissions.methods import get_tenant, has_user_management_permission
...
async def remove_user_from_tenant(user_id: UUID, tenant_id: UUID, owner_id: UUID) -> None:
    ...
    Raises:
        ...
        XingGraphValidationError: If attempting to remove the tenant owner.
    """
