...
from xinggraph.modules.users.models.PrincipalConfiguration import PrincipalConfiguration
...
async def store_principal_configuration(
    ...
    """
    Persists or updates a XingGraph configuration for a specific principal (user or group).
    ...
    Returns:
        PrincipalXingGraphConfiguration: The created or updated database model instance.
    """
