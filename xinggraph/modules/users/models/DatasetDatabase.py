...
class DatasetDatabase(Base):
    ...
    # XingGraph release that last touched these databases (informational/audit only).
    xinggraph_version = Column(String, unique=False, nullable=True)
    ...
    # runner on failure, cleared on success; surfaced by `xinggraph-cli current`.
