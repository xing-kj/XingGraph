...
class RoleNotFoundError(XingGraphValidationError):
...
class TenantNotFoundError(XingGraphValidationError):
    """User group not found"""
...
class UserNotFoundError(XingGraphValidationError):
    """User not found"""
...
class PermissionDeniedError(XingGraphValidationError):
    def __init__(
        self,
...
class PermissionNotFoundError(XingGraphValidationError):
    def __init__(
        self,
