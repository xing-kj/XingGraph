...
from xinggraph.modules.pipelines.operations.run_tasks_distributed import run_tasks_distributed
...
from xinggraph.modules.pipelines.utils import generate_pipeline_id
from xinggraph.modules.pipelines.exceptions import PipelineRunFailedError
from xinggraph.tasks.ingestion import resolve_data_directories
...
from xinggraph.modules.pipelines.operations import (
...
def override_run_tasks(new_gen):
    def decorator(original_gen):
        ...
        async def wrapper(*args, distributed=None, **kwargs):
            default_distributed_value = os.getenv("XINGGRAPH_DISTRIBUTED", "False").lower() == "true"
