...
from xinggraph.modules.pipelines.models.DataItemStatus import DataItemStatus
from xinggraph.modules.pipelines.models import PipelineContext
from xinggraph.modules.pipelines.operations.run_tasks_with_telemetry import run_tasks_with_telemetry
...
async def run_tasks_data_item_incremental(
    ...
    # If data is being added to XingGraph for the first time calculate the id of the data
    if not isinstance(data_item, Data):
        ...
        from xinggraph.tasks.ingestion.data_item import DataItem as DataItemType
        ...
        # If data was already processed by XingGraph get data id
