...
async def handle_task(
    ...
    with new_span(f"xinggraph.pipeline.task.{task_name}") as span:
        span.set_attribute(XINGGRAPH_PIPELINE_TASK_NAME, task_name)
        ...
        try:
            ...
            span.set_attribute(XINGGRAPH_RESULT_COUNT, result_count)
            span.set_attribute(
                XINGGRAPH_RESULT_SUMMARY,
