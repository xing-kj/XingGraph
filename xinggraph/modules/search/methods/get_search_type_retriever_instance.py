...
from xinggraph.modules.engine.models.node_set import NodeSet
from xinggraph.modules.retrieval.triplet_retriever import TripletRetriever
from xinggraph.modules.search.types import SearchType
from xinggraph.modules.search.operations import select_search_type
from xinggraph.modules.search.exceptions import UnsupportedSearchTypeError

# Retrievers
from xinggraph.modules.retrieval.chunks_retriever import ChunksRetriever
from xinggraph.modules.retrieval.summaries_retriever import SummariesRetriever
from xinggraph.modules.retrieval.completion_retriever import CompletionRetriever
from xinggraph.modules.retrieval.hybrid_retriever import HybridRetriever
from xinggraph.modules.retrieval.graph_completion_retriever import GraphCompletionRetriever
from xinggraph.modules.retrieval.graph_completion_decomposition_retriever import (
    GraphCompletionDecompositionRetriever,
)
from xinggraph.modules.retrieval.temporal_retriever import TemporalRetriever
from xinggraph.modules.retrieval.coding_rules_retriever import CodingRulesRetriever
from xinggraph.modules.retrieval.bm25_retriever import BM25ChunksRetriever
from xinggraph.modules.retrieval.graph_summary_completion_retriever import (
    GraphSummaryCompletionRetriever,
)
from xinggraph.modules.retrieval.graph_completion_cot_retriever import GraphCompletionCotRetriever
from xinggraph.modules.retrieval.graph_completion_context_extension_retriever import (
    GraphCompletionContextExtensionRetriever,
)
from xinggraph.modules.retrieval.cypher_search_retriever import CypherSearchRetriever
...
async def get_search_type_retriever_instance(
    ...
    **kwargs,
    ...
    search_core_registry: dict[SearchType, Tuple[BaseRetriever, dict]] = {
        ...
        SearchType.WIKI_COMPLETION: (
            WikiCompletionRetriever,
            {
                "entity_top_k": retriever_specific_config.get("entity_top_k", 8),
                "entity_per_term_k": retriever_specific_config.get("entity_per_term_k", 2),
                "subject_per_term_k": retriever_specific_config.get("subject_per_term_k", 3),
                "attribute_pool_k": retriever_specific_config.get("attribute_pool_k", 10),
                "wiki_top_k": retriever_specific_config.get("wiki_top_k", 8),
                "max_context_chunks": retriever_specific_config.get("max_context_chunks", 6),
    ...
    from xinggraph.modules.retrieval.registered_community_retrievers import (
