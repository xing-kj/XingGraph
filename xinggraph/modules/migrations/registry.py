"""The ordered chain of xinggraph data migrations (graph + vector + relational ledger).
...
from xinggraph.modules.migrations.migration import Migration, order_migrations
...
from xinggraph.modules.migrations.versions.namespace_edge_type_point_ids import (
    downgrade as namespace_edge_type_point_ids_down,
    migrate as namespace_edge_type_point_ids,
)
from xinggraph.modules.migrations.versions.postgres_graph_provenance_columns import (
...
# every XingGraph version change, even a release with no data migration. The runner
# triggers it on a xinggraph_version mismatch, after the chain (see
