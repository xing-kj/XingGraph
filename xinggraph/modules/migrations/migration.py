...
XingGraph versions are never compared for ordering — they are recorded only as
...
class Migration:
    ...
    Attributes:
        ...
        xinggraph_version: Release this migration shipped in (informational only).
...
def pending_migrations(
    ...
    if stored_revision not in _warned_unknown_revisions:
        ...
        logger.warning(
            ...
            "(`xinggraph-cli stamp base --dataset <id>` re-arms the chain). Logged once per process.",
            stored_revision,
