...
A COGX archive is a directory (see :mod:`xinggraph.modules.migration.cogx`);
...
``xinggraph.push()`` on the sending side and the remember endpoint on the
receiving side.
"""
...
from xinggraph.modules.migration.cogx import MANIFEST_FILE
