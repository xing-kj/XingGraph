...
async def run_custom_pipeline(
    ...
    """
    Custom pipeline in XingGraph, can work with already built graphs. Data needs to be provided which can be processed
    with provided tasks.
    ...
    Args:
        tasks: List of XingGraph Tasks to execute.
        ...
        incremental_loading: If True, only new or modified data will be processed to avoid duplication. (Only works if data is used with the XingGraph python Data model).
        ...
        data_cache: If True, only new or modified data will be processed to avoid duplication. (Only works if data is used with the XingGraph python Data model).
