...
Stdlib only. Never import xinggraph from this module.
"""
...
def start_parent_liveness_watchdog(poll_interval: float = 1.0) -> None:
    ...
    pid 1 (xinggraph running as the container's entrypoint), which made the
...
class spawn_without_main:
    ...
    import performed by the main script — which for xinggraph means a ~200 MB
