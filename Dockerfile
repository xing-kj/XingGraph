...
# source (measured on xinggraph-saas-pod: ~8s of a ~13s import, halving startup).
...
COPY ./xinggraph /app/xinggraph
COPY ./distributed /app/distributed
COPY ./xinggraph_db_workers /app/xinggraph_db_workers
