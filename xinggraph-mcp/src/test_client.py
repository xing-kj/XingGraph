#!/usr/bin/env python3
"""Smoke-test the public XingGraph MCP memory tools."""
...
class XingGraphTestClient:
    """Test client for the public XingGraph MCP tool surface."""
    ...
    async def test_memory_tools(self):
        ...
        memory_text = f"XingGraph MCP smoke memory {session_id}"
    ...
    async def run_all_tests(self):
        ...
        print("Starting XingGraph MCP memory tool smoke tests")
        print("=" * 50)
