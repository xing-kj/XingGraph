    ...
    <div style={{ padding: 32, display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          <span style={{ fontSize: 14, color: "rgba(237,236,234,0.55)" }}>Manage keys for programmatic access to the XingGraph API.</span>
        </div>
        <button
      ...
      <div style={{ display: "flex", gap: 12 }}>
        {isCloud && (
          <a
            href={isDev ? "https://api.dev-aws.xinggraph.ai/docs" : "https://api.aws.xinggraph.ai/docs"}
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => trackEvent({ pageName: "API Keys", eventName: "click_out", additionalProperties: { target_url: isDev ? "https://api.dev-aws.xinggraph.ai/docs" : "https://api.aws.xinggraph.ai/docs" } })}
