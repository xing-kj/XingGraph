...
import type XingGraphUser from "@/modules/users/XingGraphUser";
...
export default function ProfileWidget() {
  const [user, setUser] = useState<XingGraphUser | null>(null);
    ...
    >
      ...
      <Stack gap="0.75rem">
        <TextInput
          ...
          value={user?.name ?? ""}
          disabled
          classNames={{ input: "!h-[2.75rem] !border-xinggraph-border" }}
          radius="0.5rem"
          styles={{
