 ...
 *
 * The xinggraph parser only picks up files literally named `SKILL.md`, and derives
 ...
 * "add to brains" action — the xinggraph parser round-trips these field aliases.
