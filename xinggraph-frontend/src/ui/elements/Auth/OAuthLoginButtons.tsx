  ...
  return (
    <Flex className="flex-col gap-[1.5rem] items-center w-full max-w-[22rem]">
      <Flex className="flex-col gap-[0.5rem] items-center">
        ...
        <Text size="sm" className="!text-xinggraph-muted">
          {type === "login"
            ? "Sign in to your XingGraph account"
            : "Create your XingGraph account"}
        </Text>
      </Flex>
      ...
      <Flex className="flex-col gap-[0.75rem] w-full">
        ...
        >
          <Button
            ...
            radius="md"
            color="#ffffff"
            className="!text-black !w-full !border !border-solid !border-xinggraph-border hover:!bg-xinggraph-bg !transition-colors"
            leftSection={
      ...
      <Divider
        ...
        className="!w-full"
        classNames={{ label: "!text-xinggraph-muted !text-xs" }}
      />
