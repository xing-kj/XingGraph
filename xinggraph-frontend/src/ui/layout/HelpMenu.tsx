...
function DiscordIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="rgba(237,236,234,0.6)">
...
const MENU_ITEMS = [
  { label: "Docs", href: "https://docs.xinggraph.ai", external: true, icon: <DocsIcon /> },
  { label: "Contact us (email)", href: "mailto:social@xinggraph.ai", external: true, icon: <EnvelopeIcon /> },
  { label: "Contact us (30-minute call)", href: "https://calendly.com/luca-xing-kj/new-meeting", external: true, icon: <MeetingIcon /> },
...
export default function HelpMenu() {
  ...
  function startOnboarding() {
    sessionStorage.removeItem("xinggraph-onboarding-skipped");
    sessionStorage.removeItem("xinggraph-welcome-banner-dismissed");
  ...
  return (
    <>
    {extractionOpen && <ExtractionSettingsModal onClose={() => setExtractionOpen(false)} />}
    <div ref={containerRef} className="relative">
      ...
      >
        <span style={{ fontSize: 12, fontWeight: 700, color: "rgba(237,236,234,0.7)" }}>?</span>
      </button>
