...
WORKFLOWS=(
  ...
  "test_llama_index_xinggraph_integration_notebook.yml"
  "test_xinggraph_llama_index_notebook.yml"
  "test_xinggraph_multimedia_notebook.yml"
  "test_xinggraph_server_start.yml"
  "test_telemetry.yml"
  "test_neo4j.yml"
  "test_pgvector.yml"
  "test_ollama.yml"
